...
class AlbumPersonnel():
	...
	def initial_artist_arrays(self):
		...
		for string in split_strings[:-1]: 	# leaves out extra empty item
			...
			initial_artist_arrays.append(temporary_array)
	...
	def partition_artist_array(self, artist_array):
		...
		for word in artist_array:
			if not word.startswith("("):
				...
				break
		for word in artist_array[len(names):]:
			instruments_tracks.append(word)
		partitioned_artist_array = []
		partitioned_artist_array.append(names)
		partitioned_artist_array.append(instruments_tracks)
	...
	def partitioned_artist_arrays(self):
		...
		for array in initial_artist_arrays:
			partitioned_arrays.append(self.partition_artist_array(array))
...
# # # The Rogue-Array Correction Suite # # #
	...
	def split_multiple_artists(self, name_array):
		...
		name_array[len(array) - 1] += "," # simplifies system
		for name in name_array:
			temporary_array = []
